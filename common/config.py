...
class DbConfig():
    ...
    MYSQL_PORT = cf.getint(section, "mysql_port")
    ...
    MONGO_PORT = cf.get(section, "mongo_port")
    ...
    REDIS_PORT = cf.get(section, "redis_port")
...
class BaseConfig(object):
    ...
    APP_SLOW_LOG = cf.get(section, "app_slow_log")